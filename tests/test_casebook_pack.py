"""Regression checks for the ocamlmaze casebook."""
...
from casebook.harness import assert_expected, ocamlmaze_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ocamlmaze_summary(), assert_expected())
