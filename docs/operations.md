...
`ocamlmaze` is centered on algorithms work in OCaml. The technical target is: Generate mazes, solve shortest paths, and export stable ASCII fixtures.
...
The score is deterministic. The current threshold is 181. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 3.
